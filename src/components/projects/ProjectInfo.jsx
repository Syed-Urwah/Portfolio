			...
			<div className="w-full sm:w-2/3 text-left mt-10 sm:mt-0">
				<p className="font-general-regular text-primary-dark dark:text-primary-light text-2xl font-bold mb-7">
					{singleProjectData.ProjectInfo.ProjectDetailsHeading}
						...
						>
							{id == 2 ? 'It is a simple chat web app in which user can create account with google account or normal with email any user can send text messages to anyone realtime which also includes the media files' : id == 3 ? 'Eco is an Ecommerce app where the admin can upload products from the admin dashboard and also analysis the product growth based on purchase and review of the product' : ''}
						</p>
